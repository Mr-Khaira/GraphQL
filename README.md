...
So in a normal REST api, we create separate endpoints to fetch different resources,
but what if we do not want the whole thing and just want a part of that data ?
AKA partial fetch, then might need to create multiple endpoints, but that would
be a lot of code.
